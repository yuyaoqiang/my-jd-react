      ...
      <header>
        <div className="header-wrap">
          ...
          <div className="header-content-wrap">
            <i className="header-cotent-jd-icon iconfont icon-jingdong" />
            <i className="header-cotent-sreach-icon iconfont icon-search" />
            <a className="header-input-wrap">京品百货 每满199减100</a>
          </div>
          <div className="header-rigth-wrap">登录</div>
        </div>
      </header>
    );
  }
